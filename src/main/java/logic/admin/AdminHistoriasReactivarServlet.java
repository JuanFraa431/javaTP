...
@WebServlet("/admin/historias/reactivar")
public class AdminHistoriasReactivarServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            dao.reactivar(id);
            s.setAttribute("flash_ok", "Historia reactivada.");
        } catch (Exception e) {
            s.setAttribute("flash_error", "No se pudo reactivar.");
        }
